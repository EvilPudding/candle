...
/* 		/1* int j; for(j = 0; j < mat->mNumProperties; j++) { printf("%s\n", mat->mProperties[j]->mKey.data); } *1/ */
/* 		sauces_register_mat(material); */
/* 	} */
/* 	mc->layers[0].mat = material; */
/* } */

/* static void load_comp(entity_t entity, const struct aiScene *scene, */
...
/* 			/1* aiProcess_CalcTangentSpace  		| *1/ */
/* 			aiProcess_Triangulate			| */
/* 			/1* aiProcess_GenSmoothNormals		| *1/ */
...
/* 	} */
/* 	/1* c_model(&result)->mesh->transformation = *1/ */
/* 	/1* 	mat4_scale_aniso(c_model(&result)->mesh->transformation, vec3(scale)); *1/ */
